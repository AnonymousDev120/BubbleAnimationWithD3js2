...
const Bubbles = () => {
  ...
  const data2 = [
    { name: "Concept 1 Dummy 1", value: 10 },
    ...
    { name: "Concept 2", value: 20 },
    { name: "Concept 3 Dummy 1", value: 15 },
    { name: "Concept 1", value: 10 },
    { name: "Concept 2", value: 20 },
    { name: "Concept 3 Dummy 1", value: 15 },
  ];
  const data3 = [
    { name: "Dummy 1 Concept 3", value: 10 },
    { name: "Dummy 2", value: 20 },
    { name: "Dummy 3", value: 15 },
    { name: "Dummy 1", value: 10 },
    { name: "Dummy 2", value: 20 },
    { name: "Dummy 3 Concept 3", value: 15 },
    { name: "Dummy 1", value: 10 },
    { name: "Dummy 2", value: 20 },
    { name: "Dummy 3 Concept 3", value: 15 },
    { name: "Dummy 1", value: 10 },
  ...
  useEffect(() => {
    ...
    function bubbleClick(clickedBubble, d) {
      ...
      simulation = d3
        ...
        .velocityDecay(0.2)
        .alpha(0.5) // start with low alpha value
